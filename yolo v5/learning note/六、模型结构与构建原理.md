...
* 目标位置：models/commons.py
  * ![image-20240311212846373](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311212846373.png)
* C2f中的Bottleneck多了k参数，因此需要添加
  * ![image-20240311213143974](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311213143974.png)
* 加入C2f前缀
  * ![image-20240311213423072](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311213423072.png)

（3）设定网络结构的传参细节

* 目标位置：models/yolo.py
* 在yolo.py中加入C2f的接口，以为C2f和C3传参一致，所以可以在parse_model代码中有C3的地方加入即可：
  * ![image-20240311214205244](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311214205244.png)

（4）修改现有模型结构配置文件

* 目标位置：models/yolov5*.yaml
* 复制文件：
  * ![image-20240311215624101](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311215624101.png)
* 将backbone中的C3改为C2f
  * ![image-20240311214831733](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240311214831733.png)
