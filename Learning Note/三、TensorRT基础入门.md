...
![image-20240423094750582](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423094750582.png)
...
*  不光是Perception，后期的Planning等等也需要时间
  * ![image-20240423110002026](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423110002026.png)
  * 如果把这些所有的事情能够在几短时间内做完并达到>10fps，甚至30fps， 是一个非常具有挑战性的事情
* 工业界提高实时性办法：
  * 1、局部提高分辨率 优先处理局部区域：
    * ![image-20240423110208532](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423110208532.png)
  * 2、CPU与GPU异步处理

##### （3）自动驾驶中需要关注的电力消耗

* 基本上我们需要的算力越大，消耗的电力越大。自动驾驶所需要控制的电力一般来说需要控制在小于100w。自动驾驶也属 于Edge computing的一种，所以对电力消耗需要严格控制。
  * ![image-20240423110541351](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423110541351.png)
...
* 层融合种类：
  * Vertical layer fusion (垂直层融合)
    ...
    * ![image-20240423111510180](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423111510180.png)
  * Horizontal layer fusion (水平层融合)
    * 当模型中有水平方向上比较多的同类layer，会直接进行融合
      * ![image-20240423111540763](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423111540763.png)
* 层融合可以减少启动kernel的开销与memory操作，从而提高效率。同时，有些计算可以通过层融合优化后，跟其他计算合并
  * ![image-20240423111213532](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423111213532.png)
...
* TensorRT内部对于同一个层使用各种不同kernel函数进行性能测试
  ...
  * ![image-20240423112336869](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20240423112336869.png)
